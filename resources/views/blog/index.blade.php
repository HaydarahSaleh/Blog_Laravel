...
<div  class="container  mx-auto px-5 py-5 border-b border-gray-200">
    @if (Auth::check())
            <a href="/blog/create" class="bg-green-700 border-2 text-gray-100 py-4 px-5 rounded-lg font-bold uppercase text-l inline-block">Add Post </a>
...
<div  class="container sm:grid grid-cols-2 gap-15 mx-auto px-5 py-15 border-b border-gray-200">
    <div class="flex">
        <img class="object-cover" src="/assets/images/{{$post->image_path}} "alt=""/>
    </div>
    <div>
